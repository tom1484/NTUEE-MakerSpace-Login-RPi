    ...
    std::string text)
{
    ...
    int buf_len = wrap_frame_data(frame_data_buf, header_len, ft_color, bg_color, ft_height, thickness, text.c_str(), text.length());

    write(main_pipe[1], frame_data_buf, buf_len + 1);
}
